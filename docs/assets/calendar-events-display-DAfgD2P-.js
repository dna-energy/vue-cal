import{u as U,x as b,i as m,a as r,c as u,d as l,w as s,b as n,f as t,t as i,e as d,A as W,p as M,g as F,z as N,F as p,h as H,r as h}from"./index-WcciNudh.js";import"./index-C2WYxJUz.js";import{_ as k}from"./index-BbUrvQjI.js";const q={class:"w-flex justify-end my2"},J={key:0},I={key:1},L={class:"w-flex align-center justify-end gap2"},Y=["innerHTML"],G={class:"w-flex column align-end gap1"},R={key:0,class:"warning--bg bdrsr w-icon size--xs pa2 mr-6 mb1 align-self-end"},X={class:"w-flex justify-end mt8 mb3"},$={class:"w-flex column gap1 align-end"},_={__name:"calendar-events-display",setup(K){const D=U(),C=[{start:new Date(new Date().setHours(11,0)).subtractDays(2),end:new Date(new Date().setHours(13,0)).subtractDays(2),title:"Salsa Dance Class",content:'<i class="w-icon mdi mdi-dance-ballroom"></i>',class:"sport",schedule:2},{start:new Date(new Date().setHours(12,30)),end:new Date(new Date().setHours(13,30)),title:"Doctor Appt.",content:'<i class="w-icon mdi mdi-stethoscope"></i>',class:"health",schedule:1},{start:new Date(new Date().setHours(11,30)).addDays(1),end:new Date(new Date().setHours(12,30)).addDays(1),title:"Dentist Appt.",content:'<i class="w-icon mdi mdi-tooth"></i>',class:"health",schedule:2},{start:new Date(new Date().setHours(13,0)).addDays(1),end:new Date(new Date().setHours(14,0)).addDays(1),title:"Cross-fit",content:'<i class="w-icon mdi mdi-dumbbell"></i>',class:"sport",schedule:2},{start:new Date(new Date().setHours(10,0)).addDays(3),end:new Date(new Date().setHours(11,30)).addDays(3),title:"Swimming Class",content:'<i class="w-icon mdi mdi-swim"></i>',class:"sport",schedule:2},{start:new Date(new Date().setHours(11,35)).addDays(3),end:new Date(new Date().setHours(12,30)).addDays(3),title:"Brunch with Jane",content:'<i class="w-icon mdi mdi-food-croissant"></i>',class:"leisure",schedule:1,background:!1},{start:new Date(new Date().setHours(9,0)).addDays(4),end:new Date(new Date().setHours(10,0)).addDays(4),title:"Doctor Appt.",content:'<i class="w-icon mdi mdi-stethoscope"></i>',class:"health",schedule:1},{start:new Date(new Date().setHours(11,30)).addDays(4),end:new Date(new Date().setHours(12,25)).addDays(4),title:"BK with Mark",content:'<i class="w-icon mdi mdi-food"></i>',class:"leisure",schedule:2},{start:new Date(new Date().setHours(12,30)).addDays(4),end:new Date(new Date().setHours(14,30)).addDays(4),title:"Movie Theater",content:'<i class="w-icon mdi mdi-ticket"></i>',class:"leisure",schedule:1},{start:new Date(new Date().setHours(11,30,21,0)).addDays(5),end:new Date(new Date().setHours(12,30,23,30)).addDays(5),title:"Movie Night",content:'<i class="w-icon mdi mdi-popcorn"></i>',class:"leisure",schedule:1},{start:new Date(new Date().setHours(10,0)).addDays(7),end:new Date(new Date().setHours(11,0)).addDays(7),title:"Doctor Appt.",content:'<i class="w-icon mdi mdi-stethoscope"></i>',class:"health",schedule:1}],y=b({showBgEvents:m(!1),initEvents:()=>{const w=[...C,...Array(5).fill({}).map((e,x)=>({start:new Date(new Date().setHours(12,0)).addDays(x),end:new Date(new Date().setHours(14,0)).addDays(x),class:"lunch",background:!0}))];return w[2]={...w[2],backgroundColor:"rgb(158 199 237)",color:"#0e5597"},delete w[2].class,w},allEvents:[],events:H(()=>y.allEvents.filter(w=>y.showBgEvents||!w.background))});y.allEvents=y.initEvents();const A=b({events:[{start:new Date,end:new Date,title:"Salsa Dance Class",content:'<i class="w-icon mdi mdi-dance-ballroom"></i>',class:"sport"},{start:new Date,end:new Date,title:"Dentist Appt.",content:'<i class="w-icon mdi mdi-tooth"></i>',class:"health"},{start:new Date().addDays(1),end:new Date().addDays(1),title:"Golf with John",content:'<i class="w-icon mdi mdi-golf"></i>',class:"sport"},{start:new Date().addDays(2),end:new Date().addDays(2),title:"Grocery Shopping",content:'<i class="w-icon mdi mdi-cart-outline"></i>',class:"leisure"},{start:new Date().addDays(2),end:new Date().addDays(2),title:"Dad's Birthday!",content:'<i class="w-icon mdi mdi-cake-variant-outline"></i>',class:"sport"},{start:new Date().addDays(3),end:new Date().addDays(3),title:"Doctor Appt.",content:'<i class="w-icon mdi mdi-stethoscope"></i>',class:"health"},{start:new Date().addDays(4),end:new Date().addDays(4),title:"Burger King",content:'<i class="w-icon mdi mdi-food"></i>',class:"leisure"}]}),v=b({showDialog:!1,openDialog:({event:w})=>{v.event=w,v.showDialog=!0},events:[...C]}),a=b({showEvents:m(!0),showEventCount:m(!1),highlightCells:m(!1),eventCountStyle:m("dot"),eventCountStyleOptions:[{label:"Dot",value:"dot"},{label:"Dash",value:"dash"},{label:"Caption",value:"caption"},{label:"Use slot",value:"slot"}],classes:H(()=>({[`event-count--${a.eventCountStyle}`]:a.showEventCount,"vuecal--highlight-cells":a.highlightCells}))}),E=b({events:m([...C.map(w=>({...w})),{start:new Date(new Date().setHours(12,0)).addDays(1),end:new Date(new Date().setHours(14,0)).addDays(1),title:"Event 1",class:"event-1"},{start:new Date(new Date().setHours(12,0)).addDays(1),end:new Date(new Date().setHours(14,0)).addDays(1),title:"Event 2",class:"event-2"},{start:new Date(new Date().setHours(11,0)).addDays(2),end:new Date(new Date().setHours(13,0)).addDays(2),title:"Event 3",class:"event-3"},{start:new Date(new Date().setHours(12,0)).addDays(2),end:new Date(new Date().setHours(14,0)).addDays(2),title:"Event 4",class:"event-4"}]),minEventWidth:m(0),stackEvents:m(!1)}),c=b({allDayEvents:m(0),allDayBarOn:m(!0),allDayEventsOn:m(!0),events:H(()=>[{start:new Date().format(),end:new Date().addDays(1).format(),title:"Day off!",content:'<i class="w-icon mdi mdi-umbrella-beach-outline"></i>',class:"yellow-event",allDay:c.allDayEventsOn},{start:new Date().addDays(1).format(),end:new Date().addDays(2).format(),title:"Anniversary ❤️",content:'<i class="w-icon mdi mdi-heart-outline"></i>',class:"pink-event",allDay:c.allDayEventsOn},{start:new Date().addDays(1).format(),end:new Date().addDays(2).format(),title:"Grocery Shopping",content:'<i class="w-icon mdi mdi-cart-outline"></i>',class:"leisure",allDay:c.allDayEventsOn},{start:new Date(new Date().addDays(1).setHours(10,35)),end:new Date(new Date().addDays(1).setHours(11,30)),title:"Doctor Appt.",content:'<i class="w-icon mdi mdi-stethoscope"></i>',class:"health",schedule:1}])}),O=b({events:[{start:new Date(new Date().setMinutes(0,0,0)),end:new Date(new Date().setHours(23,0,0,0)).addDays(1),title:"Running Marathon",content:'<i class="w-icon mdi mdi-run"></i>',class:"sport"},{start:new Date().addDays(1),end:new Date().addDays(1).addHours(1),title:"Drink water!",content:'<i class="w-icon mdi mdi-glass-cocktail"></i>',class:"health drink-water"},{start:new Date(new Date().setHours(6,0,0,0)).addDays(2),end:new Date(new Date().setHours(21,0,0,0)).addDays(4),title:"Trip to India",content:'<i class="w-icon mdi mdi-airplane"></i>',class:"leisure"}]});return(w,e)=>{const x=h("alert"),f=h("w-switch"),g=h("example"),V=h("w-icon"),z=h("w-dialog"),B=h("router-link"),T=h("w-radios"),j=h("w-image");return r(),u(p,null,[l(x,{info:""},{default:s(()=>[e[24]||(e[24]=n("h3",{class:"mt-2 mb2"},"Read First",-1)),e[25]||(e[25]=n("p",null,"Events are always rendered in cells, whether a time column is displayed or not.",-1)),n("ul",null,[e[22]||(e[22]=n("li",null,[t("Events are defined essentially with "),n("code",null,"start"),t(" and "),n("code",null,"end"),t(` attributes, but can contain a
...
`,-1))])]),_:1}),l(g,{title:"Events & Background Events",anchor:"events"},{desc:s(()=>[e[27]||(e[27]=n("p",null,[t("Events are defined by a "),n("code",null,"start"),t(" and "),n("code",null,"end"),t(` dates, provided as a JavaScript Date object
...
`)])],-1)),n("div",q,[l(f,{modelValue:y.showBgEvents,"onUpdate:modelValue":e[0]||(e[0]=o=>y.showBgEvents=o)},{default:s(()=>[...e[26]||(e[26]=[t("Show Background Events",-1)])]),_:1},8,["modelValue"])])]),"code-html":s(()=>[...e[29]||(e[29]=[t('<vue-cal :events="events" />',-1)])]),"code-js":s(()=>[e[30]||(e[30]=t(`const events = [
  {
...
`,-1)),y.showBgEvents?(r(),u("span",J,`  {
    start: new Date(new Date().setHours(12, 0, 0, 0)),
    end: new Date(new Date().setHours(14, 0, 0, 0)),
    class: 'lunch',
    background: true // Background event.
  },
`)):(r(),u("span",I)),e[31]||(e[31]=t(`  ...
...
.vuecal__event.lunch {
  ...
  border: none;
}`,1)]),default:s(()=>[l(d(k),{"time-from":540,"time-to":840,events:y.events,"onUpdate:events":e[1]||(e[1]=o=>y.events=o),views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:d(D).darkMode,style:{height:"261px"}},null,8,["events","dark"])]),_:1}),l(g,{title:"Timeless Events",anchor:"timeless-events"},{desc:s(()=>[...e[32]||(e[32]=[n("p",null,[t("When "),n("code",null,"time"),t(" is set to "),n("code",null,"false"),t(`, the calendar and the events are timeless. The events can't be
resized.`)],-1)])]),"code-html":s(()=>[...e[33]||(e[33]=[t('<vue-cal :time="false" :events="events" />',-1)])]),"code-js":s(()=>[...e[34]||(e[34]=[t(`const events = [
  ...
  ...
]`,-1)])]),default:s(()=>[l(d(k),{dark:d(D).darkMode,time:!1,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,events:A.events},null,8,["dark","events"])]),_:1}),l(g,{title:"Open a Dialog on Event Click",anchor:"open-dialog-on-event-click"},{desc:s(()=>[...e[35]||(e[35]=[n("p",{class:"mb2"},[t(`You can attach whatever event listener you want to the events: it only needs to start with
...
`,-1)])]),default:s(()=>[l(d(k),{class:"ex--open-dialog-on-event-click",events:v.events,"time-from":540,"time-to":900,views:{days:{cols:5,rows:1}},view:"days","views-bar":!1,dark:d(D).darkMode,onEventClick:v.openDialog},null,8,["events","dark","onEventClick"])]),_:1}),v.event?(r(),W(z,{key:0,modelValue:v.showDialog,"onUpdate:modelValue":e[2]||(e[2]=o=>v.showDialog=o),title:v.event.title,width:"380"},{default:s(()=>[n("div",L,[l(V,{class:"grey"},{default:s(()=>[...e[38]||(e[38]=[t("mdi mdi-calendar",-1)])]),_:1}),n("small",null,i(v.event.start.format()),1),l(V,{class:"grey ml2"},{default:s(()=>[...e[39]||(e[39]=[t("mdi mdi-clock-outline",-1)])]),_:1}),n("small",null,i(v.event.start.formatTime())+" - "+i(v.event.end.formatTime()),1)]),n("div",{class:"w-flex align-center justify-center title1 mt6 mb4",innerHTML:v.event.content},null,8,Y),e[40]||(e[40]=n("p",{class:"lh1"},`Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil inventore expedita veniam deleniti,
labore corporis quas, aspernatur praesentium quia nisi, omnis quod autem.
`,-1))]),_:1},8,["modelValue","title"])):M("",!0),l(g,{title:"Month View Events & Count",anchor:"events-on-month-view"},{desc:s(()=>[n("ul",null,[e[44]||(e[44]=n("li",null,[t("When "),n("code",null,"events-on-month-view"),t(` is set to true, the events will show in full on the month view
...
`,-1)),l(B,{to:"/examples/customization#ex--events-on-month-view"},{default:s(()=>[...e[41]||(e[41]=[t("Events on Month View Customization",-1)])]),_:1}),e[43]||(e[43]=t(`.
`,-1))])]),n("div",G,[l(f,{modelValue:a.showEvents,"onUpdate:modelValue":[e[3]||(e[3]=o=>a.showEvents=o),e[4]||(e[4]=o=>a.showEvents&&(a.showEventCount=!1))],"label-on-left":""},{default:s(()=>[...e[47]||(e[47]=[t("Show Events",-1)])]),_:1},8,["modelValue"]),l(f,{modelValue:a.showEventCount,"onUpdate:modelValue":[e[5]||(e[5]=o=>a.showEventCount=o),e[6]||(e[6]=o=>a.showEventCount&&(a.showEvents=!1))],"label-on-left":""},{default:s(()=>[...e[48]||(e[48]=[t("Show Event Count",-1)])]),_:1},8,["modelValue"]),l(T,{modelValue:a.eventCountStyle,"onUpdate:modelValue":e[7]||(e[7]=o=>a.eventCountStyle=o),inline:"",items:a.eventCountStyleOptions,disabled:!a.showEventCount},{default:s(()=>[...e[49]||(e[49]=[t("Events Count Style",-1)])]),_:1},8,["modelValue","items","disabled"]),e[51]||(e[51]=n("p",{class:"caption"},"For illustration, the slot option will only count orange events (with the `leisure` class).",-1)),l(f,{modelValue:a.highlightCells,"onUpdate:modelValue":e[8]||(e[8]=o=>a.highlightCells=o),"label-on-left":""},{default:s(()=>[...e[50]||(e[50]=[t("Highlight Cells with Events",-1)])]),_:1},8,["modelValue"])])]),"code-html":s(()=>[t(`<vue-cal
...
`,1),a.showEventCount&&a.eventCountStyle==="slot"?(r(),u(p,{key:0},[t(`
...
</template>`)],64)):(r(),u(p,{key:1},[],64))]),"code-css":s(()=>[e[52]||(e[52]=t(`.vuecal {
  height: 506px;
...
`,-1)),a.showEventCount?a.eventCountStyle==="dot"?(r(),u(p,{key:1},[t(`  .event-count--dot .vuecal__cell-events-count {
    position: absolute;
    bottom: 14px;
    right: 15%;
...
`)],64)):a.eventCountStyle==="dash"?(r(),u(p,{key:2},[t(`  .event-count--dash .vuecal__cell-events-count {
    position: absolute;
    top: 24px;
    right: 12px;
    text-align: center;
...
`)],64)):a.eventCountStyle==="caption"?(r(),u(p,{key:3},[t(`  .event-count--caption .vuecal__cell-events-count {
    position: absolute;
    inset: auto 2px 2px;
    text-align: center;
    opacity: 0.3;
...
`)],64)):(r(),u(p,{key:4},[],64)):(r(),u(p,{key:0},[],64)),a.highlightCells?(r(),u(p,{key:5},[t("  .vuecal__cell--has-events {background-color: "+i(d(D).darkMode?"#00dbff1c":"#fffacda8")+`;}
`,1)],64)):(r(),u(p,{key:6},[],64)),e[53]||(e[53]=t("}",-1))]),default:s(()=>[l(d(k),{events:C,"events-on-month-view":a.showEvents,"event-count":a.showEventCount,"time-from":480,"time-to":1080,views:{days:{cols:5,rows:1},month:{},year:{}},view:"month",dark:d(D).darkMode,class:F(a.classes),style:{height:"506px"}},N({_:2},[a.showEventCount&&a.eventCountStyle==="slot"?{name:"event-count",fn:s(({events:o})=>[o.filter(S=>S.class==="leisure").length?(r(),u("span",R,i(o.filter(S=>S.class==="leisure").length),1)):M("",!0)]),key:"0"}:void 0]),1032,["events-on-month-view","event-count","dark","class"])]),_:1}),l(g,{title:"Overlapping Events",anchor:"overlapping-events"},{desc:s(()=>[e[56]||(e[56]=n("p",null,[t("Overlapping, editable & deletable events."),n("br"),t(`
...
Example of classes for three overlapping events: `),n("code",null,"vuecal__event--stack-1-3"),t(", "),n("code",null,"vuecal__event--stack-2-3"),t(", "),n("code",null,"vuecal__event--stack-3-3"),t(".")],-1)),l(j,{src:"/images/calendar-events-display-overlapping-events.webp",lazy:"","aspect-ratio":1076/336,"max-width":"500px"})]),_:1}),n("div",X,[l(f,{modelValue:E.stackEvents,"onUpdate:modelValue":e[9]||(e[9]=o=>E.stackEvents=o),"label-on-left":""},{default:s(()=>[...e[55]||(e[55]=[t("Stack Events",-1)])]),_:1},8,["modelValue"])])]),"code-html":s(()=>[t(`<vue-cal
...
will show up as normal events.`)],-1)),e[63]||(e[63]=n("p",{class:"mb2"},[t("You can also customize the all-day bar size via CSS using the "),n("code",null,"--vuecal-all-day-bar-size"),t(` CSS variable,
and you can also use the built-in bottom resizer to change the height dynamically.
`)],-1)),n("div",$,[l(f,{modelValue:c.allDayBarOn,"onUpdate:modelValue":e[10]||(e[10]=o=>c.allDayBarOn=o),"label-on-left":""},{default:s(()=>[...e[58]||(e[58]=[t("Show All-day Bar",-1)])]),_:1},8,["modelValue"]),l(f,{modelValue:c.allDayEventsOn,"onUpdate:modelValue":e[11]||(e[11]=o=>c.allDayEventsOn=o),"label-on-left":""},{default:s(()=>[...e[59]||(e[59]=[t("Switch on all ",-1),n("code",{class:"ml1"},"event.allDay",-1)])]),_:1},8,["modelValue"])])]),"code-html":s(()=>[t(`<vue-cal
  :events="events"`+i(c.allDayBarOn?`
  all-day-events`:"")+`
  :time-from="7 * 60">
...
const events = [
  {
    ...
    allDay: `+i(c.allDayEventsOn?"true":"false")+`,
    title: 'Day off!',
...
`,-1)])]),default:s(()=>[l(d(k),{"time-from":420,view:"days",views:{day:{},days:{cols:5,rows:1},week:{},month:{}},"all-day-events":c.allDayBarOn,events:c.events,dark:d(D).darkMode},null,8,["all-day-events","events","dark"])]),_:1}),l(g,{title:"Multiple Day Events",anchor:"multiple-day-events"},{title:s(()=>[...e[65]||(e[65]=[t("Multiple Day Events",-1),n("div",{class:"todo-tag prod d-iflex ml2"},"COMING SOON",-1)])]),desc:s(()=>[e[67]||(e[67]=n("p",null,[t("Multiple day events work like a set of single day events linked together."),n("br"),t(`
...
the option `),n("code",null,"editableEvents.resizeX"),t(".")],-1)),e[68]||(e[68]=n("strong",null,"Drag & drop is not available on multiple day events for now.",-1)),l(x,{tip:""},{default:s(()=>[...e[66]||(e[66]=[t(`3 CSS classes are available to target the event first day, the last day and all the days in between:
`,-1),n("code",null,"event-start",-1),t(", ",-1),n("code",null,"event-middle",-1),t(", ",-1),n("code",null,"event-end",-1),t(".",-1)])]),_:1})]),"code-html":s(()=>[...e[69]||(e[69]=[t(`<vue-cal
  :time-from="8 * 60"
  :time-to="23 * 60"
  :views="['day', 'week']"
  hide-weekends
...
})`,-1)])]),default:s(()=>[l(d(k),{view:"days",views:{day:{},days:{cols:5,rows:1},week:{},month:{}},dark:d(D).darkMode,"events-count-on-year-view":"","editable-events":{resizeX:!0},events:O.events,onReady:e[12]||(e[12]=({view:o})=>o.scrollToCurrentTime()),style:{height:"506px"}},null,8,["dark","events"])]),_:1})],64)}}};export{_ as default};
