import{u as I,D as J,x as V,a as d,c as r,d as o,w as s,f as n,b as t,e as u,z as O,y as z,I as R,F as m,j as L,g as E,t as i,p as A,n as F,r as k,i as v,A as W}from"./index-WcciNudh.js";import{c as G,s as N}from"./index-C2WYxJUz.js";import{_ as M}from"./index-BbUrvQjI.js";const P={class:"ml1",href:"https://vuejs.org/guide/components/slots.html#scoped-slots",target:"_blank"},K={class:"w-flex column gap1 mt2"},q=["innerHTML"],Q={class:"w-flex gap2 mla no-grow"},X=["innerHTML"],Z=["innerHTML"],_={class:"orange-light2"},ee={class:"w-flex gap2 my2 justify-end"},te={href:"https://vuejs.org/guide/components/slots.html#scoped-slots",target:"_blank"},ne={key:0},le={key:1},se={key:2},ae={key:3},oe={key:4},ie={key:5},de=["onClick"],re={href:"https://vuejs.org/guide/components/slots.html#scoped-slots",target:"_blank"},ue=["innerHTML"],me={class:"mt2 w-flex wrap justify-center lh0"},ce={class:"mx1"},ve={class:"ml1"},he={__name:"customization",setup(pe){const p=I(),j=v(null),a=V({title:v(!1),prevNextButtons:v(!1),nextButton:v(!1),todayButton:v(!1),weekdayHeading:v(!1),timeCell:v(!1),cellContent:v(!1),header:v(!1),diy:v(!1),view:v("week")});J(()=>`${a.title} ${a.prevNextButtons} ${a.nextButton} ${a.todayButton} ${a.weekdayHeading} ${a.timeCell} ${a.cellContent} ${a.header} ${a.diy}`,()=>{var c,e;return(e=(c=j.value)==null?void 0:c.refreshHeight)==null?void 0:e.call(c)});const U=[{label:"John",color:"blue",class:"schedule1"},{label:"Tom",color:"green",class:"schedule2"},{label:"Kate",color:"orange",class:"schedule3"},{label:"Jess",color:"red",class:"schedule4"}],S=[{start:"2018-10-30 10:30",end:"2018-10-30 11:30",title:"Doctor appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:1},{start:"2018-11-16 10:30",end:"2018-11-16 11:30",title:"Doctor appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:1},{start:"2018-11-19 10:35",end:"2018-11-19 11:30",title:"Doctor appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:1},{start:"2018-11-19 18:30",end:"2018-11-19 19:15",title:"Dentist appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:2},{start:"2018-11-20 18:30",end:"2018-11-20 20:30",title:"Cross-fit",content:'<i class="w-icon mdi mdi-dumbbell"></i>',class:"sport",schedule:2},{start:"2018-11-21 11:00",end:"2018-11-21 13:00",title:"Brunch with Jane",content:'<i class="w-icon mdi mdi-coffee-outline"></i>',class:"leisure",schedule:1,background:!1},{start:"2018-11-21 19:30",end:"2018-11-21 23:00",title:"Swimming lesson",content:'<i class="w-icon mdi mdi-pool"></i>',class:"sport",schedule:2},{start:"2018-11-23 12:30",end:"2018-11-23 13:00",title:"Macca's with Mark",content:'<i class="w-icon mdi mdi-food"></i>',class:"leisure",schedule:2},{start:"2018-11-23 21:00",end:"2018-11-23 23:30",title:"Movie time",content:'<i class="w-icon mdi mdi-ticket"></i>',class:"leisure",schedule:1},{start:"2018-11-30 21:00",end:"2018-11-30 23:30",title:"Another movie tonight",content:'<i class="w-icon mdi mdi-ticket"></i>',class:"leisure",schedule:1}];S.slice(0);const x=V({view:v("day")}),T=V({viewDate:new Date().subtractDays(2),events:[{start:new Date(new Date().subtractDays(1).setHours(9,0,0,0)),end:new Date(new Date().subtractDays(1).setHours(12,0,0,0)),title:"Golf with John",icon:"mdi mdi-golf",class:"text-center sport"},{start:new Date(new Date().addDays(1).setHours(12,0,0,0)),end:new Date(new Date().addDays(1).setHours(15,0,0,0)),title:"Shopping",icon:"mdi mdi-cart-outline",class:"text-center leisure"}]}),g=V({events:[...S],view:v("month"),onViewChange:c=>{g.fetchEvents(c.start.format(),c.end.format())},fetchEvents:async(c,e)=>{const w=N(c),f=N(e);g.events=g.generateRandomEvents(w,f)},generateRandomEvents:(c,e)=>{const w=G(c,e),f=[];for(let y=0;y<w;y++)for(let h=0;h<10;h++){const C=new Date(c.addDays(y).setHours(Math.floor(Math.random()*8)+9,Math.floor(Math.random()*60),0,0)),b=C.addHours(1);f.push({title:`Event ${h}`,start:C,end:b})}return f}});return(c,e)=>{const w=k("w-icon"),f=k("alert"),y=k("w-switch"),h=k("w-button"),C=k("w-tooltip"),b=k("example"),$=k("w-radios"),Y=k("ssh-pre");return d(),r(m,null,[o(f,{class:"mb2"},{default:s(()=>[e[14]||(e[14]=n("If you're not familiar with slots and scoped slots, first read about it in the",-1)),t("a",P,[e[13]||(e[13]=t("strong",null,"official Vue documentation",-1)),o(w,{class:"primary ml1"},{default:s(()=>[...e[12]||(e[12]=[n("mdi mdi-open-in-new",-1)])]),_:1})]),e[15]||(e[15]=n(".",-1))]),_:1}),o(f,null,{default:s(()=>[...e[16]||(e[16]=[n("Here is the list of available slots:",-1),t("ul",null,[t("li",null,[t("span",{class:"code"},"title")]),t("li",null,[t("span",{class:"code"},"title.day")]),t("li",null,[t("span",{class:"code"},"title.days")]),t("li",null,[t("span",{class:"code"},"title.week")]),t("li",null,[t("span",{class:"code"},"title.month")]),t("li",null,[t("span",{class:"code"},"title.year")]),t("li",null,[t("span",{class:"code"},"title.years")]),t("li",null,[t("span",{class:"code"},"previous-button")]),t("li",null,[t("span",{class:"code"},"next-button")]),t("li",null,[t("span",{class:"code"},"today-button")]),t("li",null,[t("span",{class:"code"},"weekday-heading")]),t("li",null,[t("span",{class:"code"},"schedule-heading")]),t("li",null,[t("span",{class:"code"},"time-cell")]),t("li",null,[t("span",{class:"code"},"week-number-cell")]),t("li",null,[t("span",{class:"code"},"cell")]),t("li",null,[t("span",{class:"code"},"cell-content")]),t("li",null,[t("span",{class:"code"},"cell-events")]),t("li",null,[t("span",{class:"code"},"event")]),t("li",null,[t("span",{class:"code"},"event.all-day")]),t("li",null,[t("span",{class:"code"},"event.day")]),t("li",null,[t("span",{class:"code"},"event.days")]),t("li",null,[t("span",{class:"code"},"event.week")]),t("li",null,[t("span",{class:"code"},"event.month")]),t("li",null,[t("span",{class:"code"},"event.year")]),t("li",null,[t("span",{class:"code"},"event.years")]),t("li",null,[t("span",{class:"code"},"events-count")])],-1)])]),_:1}),o(b,{ref_key:"exSlotsExampleEl",ref:j,title:"Simple Slots",anchor:"slots"},{desc:s(()=>[e[25]||(e[25]=t("p",null,[n(`Vue Cal is designed to be as flexible and customizable as possible, offering a variety of slots to
...
`)],-1)),t("div",K,[o(y,{modelValue:a.title,"onUpdate:modelValue":e[0]||(e[0]=l=>a.title=l),disabled:a.header||a.diy},{default:s(()=>[...e[17]||(e[17]=[n("Custom title via ",-1),t("code",{class:"mx1"},"title",-1),n(" slot",-1)])]),_:1},8,["modelValue","disabled"]),o(y,{modelValue:a.prevNextButtons,"onUpdate:modelValue":e[1]||(e[1]=l=>a.prevNextButtons=l),disabled:a.header||a.diy},{default:s(()=>[...e[18]||(e[18]=[n("Custom arrows via ",-1),t("code",{class:"mx1"},"previous-button",-1),n(" & ",-1),t("code",{class:"mx1"},"next-button",-1),n(" slots",-1)])]),_:1},8,["modelValue","disabled"]),o(y,{modelValue:a.todayButton,"onUpdate:modelValue":e[2]||(e[2]=l=>a.todayButton=l),disabled:a.header||a.diy},{default:s(()=>[...e[19]||(e[19]=[n("Custom today button via ",-1),t("code",{class:"mx1"},"today-button",-1),n(" slot",-1)])]),_:1},8,["modelValue","disabled"]),o(y,{modelValue:a.weekdayHeading,"onUpdate:modelValue":e[3]||(e[3]=l=>a.weekdayHeading=l),disabled:a.header||a.diy},{default:s(()=>[...e[20]||(e[20]=[n("Custom weekday labels via ",-1),t("code",{class:"mx1"},"weekday-heading",-1),n(" slot",-1)])]),_:1},8,["modelValue","disabled"]),o(y,{modelValue:a.header,"onUpdate:modelValue":e[4]||(e[4]=l=>a.header=l),disabled:a.diy},{default:s(()=>[...e[21]||(e[21]=[n("Custom header via ",-1),t("code",{class:"mx1"},"header",-1),n(" slot",-1)])]),_:1},8,["modelValue","disabled"]),o(y,{modelValue:a.timeCell,"onUpdate:modelValue":e[5]||(e[5]=l=>a.timeCell=l),disabled:a.diy},{default:s(()=>[...e[22]||(e[22]=[n("time cell labels via ",-1),t("code",{class:"mx1"},"time-cell",-1),n(" slot",-1)])]),_:1},8,["modelValue","disabled"]),o(y,{modelValue:a.cellContent,"onUpdate:modelValue":e[6]||(e[6]=l=>a.cellContent=l),disabled:a.diy},{default:s(()=>[...e[23]||(e[23]=[n("Custom cell content via ",-1),t("code",{class:"mx1"},"cell-content",-1),n(" slot",-1)])]),_:1},8,["modelValue","disabled"]),o(y,{modelValue:a.diy,"onUpdate:modelValue":e[7]||(e[7]=l=>a.diy=l)},{default:s(()=>[...e[24]||(e[24]=[n("DIY via ",-1),t("code",{class:"mx1"},"diy",-1),n(" slot: you've got the power, build something nice!",-1)])]),_:1},8,["modelValue"])])]),"code-html":s(()=>[e[30]||(e[30]=n('<vue-cal :time-from="9 * 60" :time-to="14 * 60">',-1)),a.diy?(d(),r(m,{key:0},[e[26]||(e[26]=n(`
...
</vue-cal>`,-1))]),default:s(()=>[o(u(M),{class:"grow",view:a.view,"onUpdate:view":e[8]||(e[8]=l=>a.view=l),"time-from":540,"time-to":900,dark:u(p).darkMode,style:{height:"331px"}},O({_:2},[a.todayButton?{name:"today-button",fn:s(({navigate:l,active:D})=>[o(C,{left:""},{activator:s(({on:B})=>[o(h,z(R({...B,click:l}),{onClick:l,disabled:D,color:"orange-light2",text:"",icon:"mdi mdi-calendar-today","icon-props":{size:"1.2rem"}}),null,16,["onClick","disabled"])]),default:s(()=>[e[32]||(e[32]=t("span",null,"Go to Today's date",-1))]),_:2},1024)]),key:"0"}:void 0,a.header?{name:"header",fn:s(({view:l,availableViews:D})=>[t("div",{class:E(["w-flex gap2 pa1 align-center",u(p).darkMode?"orange-dark3--bg":"orange-light5--bg"])},[o(h,{color:"base-color",icon:"wi-chevron-left",onClick:l.previous},null,8,["onClick"]),t("div",{class:"base-color",innerHTML:l.title},null,8,q),o(h,{color:"base-color",icon:"wi-chevron-right",onClick:l.next},null,8,["onClick"]),t("div",Q,[(d(!0),r(m,null,L(D,(B,H)=>(d(),W(h,{class:"text-upper",onClick:we=>a.view=H,color:"base-color",outline:l.id===H,sm:""},{default:s(()=>[n(i(H),1)]),_:2},1032,["onClick","outline"]))),256))])],2)]),key:"1"}:void 0,a.title?{name:"title",fn:s(({title:l})=>[t("code",{class:"orange-light2",innerHTML:l},null,8,X)]),key:"2"}:void 0,a.weekdayHeading?{name:"weekday-heading",fn:s(({label:l,id:D})=>[t("strong",{class:E(["orange-light2",D]),innerHTML:l},null,10,Z)]),key:"3"}:void 0,a.prevNextButtons?{name:"previous-button",fn:s(()=>[o(w,{class:"orange-light2",md:""},{default:s(()=>[...e[33]||(e[33]=[n("mdi mdi-arrow-left",-1)])]),_:1})]),key:"4"}:void 0,a.prevNextButtons?{name:"next-button",fn:s(()=>[o(w,{class:"orange-light2",md:""},{default:s(()=>[...e[34]||(e[34]=[n("mdi mdi-arrow-right",-1)])]),_:1})]),key:"5"}:void 0,a.timeCell?{name:"time-cell",fn:s(({format24:l})=>[t("strong",_,i(l),1)]),key:"6"}:void 0,a.cellContent?{name:"cell-content",fn:s(()=>[o(w,{class:"orange-light2",lg:""},{default:s(()=>[...e[35]||(e[35]=[n("mdi mdi-party-popper",-1)])]),_:1})]),key:"7"}:void 0,a.diy?{name:"diy",fn:s(({vuecal:l})=>[n(i(l),1)]),key:"8"}:void 0]),1032,["view","dark"])]),_:1},512),o(b,{title:"Custom Title Per View",anchor:"custom-title-per-view"},{desc:s(()=>[e[38]||(e[38]=t("p",null,[n(`If you need a custom title only on a specific view and want to keep it simple,
...
`)],-1)),t("div",ee,[e[36]||(e[36]=t("span",{class:"text-right"},"Override title only on:",-1)),o($,{modelValue:x.view,"onUpdate:modelValue":e[9]||(e[9]=l=>x.view=l),items:["day","days","week","month","year","years"].map(l=>({label:l,value:l})),inline:""},null,8,["modelValue","items"]),e[37]||(e[37]=t("span",null,"view.",-1))])]),"code-html":s(()=>[n(`<vue-cal>
...
`,-1)),t("a",te,[e[41]||(e[41]=n("vuejs.org/guide/components/slots.htm ",-1)),o(w,{color:"primary"},{default:s(()=>[...e[40]||(e[40]=[n("mdi mdi-open-in-new",-1)])]),_:1})])]),_:1}),e[62]||(e[62]=t("p",{class:"mt6 mb2"},[n("Accessible payload through the "),t("span",{class:"code"},"#cell-content"),n(" scoped slot:")],-1)),e[63]||(e[63]=t("ul",null,[t("li",null,[t("span",{class:"code"},"cell"),n(", object containing the cell date range and the cell events.")])],-1)),e[64]||(e[64]=t("p",null,[n("In this example, only the cell number is clickable on month view."),t("br"),n(`
...
<div class="vuecal__cell-events-count" />`,-1)])]),_:1},8,["dark"]),o(Y,{class:"my1",language:"html-vue",dark:u(p).darkMode},{default:s(()=>[...e[56]||(e[56]=[n(`    <div class="vuecal__cell-events" />
</div>`,-1)])]),_:1},8,["dark"])]),_:1})]),"code-html":s(()=>[...e[65]||(e[65]=[n(`<vue-cal
  :time="false"
