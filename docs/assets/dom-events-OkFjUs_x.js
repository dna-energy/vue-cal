import{u as I,x as V,J as H,i as c,a as x,c as C,d as a,w as s,f as l,b as t,t as f,e as g,F as S,j as P,A as W,p as L,y as $,r as E}from"./index-WcciNudh.js";import{s as z,c as U}from"./index-C2WYxJUz.js";import{_ as M}from"./index-BbUrvQjI.js";const F={class:"ml1 text-bold",href:"https://https://vuejs.org/guide/essentials/event-handling.html",target:"_blank"},O={class:"logs-box bd1 bdrs2 ovh"},Y={class:"w-flex wrap align-center justify-end ml2 mr1"},J={class:"example mt6 mb2 mxa"},G={class:"example mt2 mb2 mxa"},q={class:"caption text-center"},K={class:"mxa my3",style:{"max-width":"500px"}},Q={class:"w-flex gap2 basis-zero"},X={class:"w-flex gap2 my2 basis-zero"},Z={class:"code"},_={class:"code"},ee={class:"code"},te={class:"w-flex align-center justify-center wrap gap2"},ae={__name:"dom-events",setup(ne){const b=I(),i=c("week"),A=[{start:"2018-10-30 10:30",end:"2018-10-30 11:30",title:"Doctor appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:1},{start:"2018-11-16 10:30",end:"2018-11-16 11:30",title:"Doctor appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:1},{start:"2018-11-19 10:35",end:"2018-11-19 11:30",title:"Doctor appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:1},{start:"2018-11-19 18:30",end:"2018-11-19 19:15",title:"Dentist appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:2},{start:"2018-11-20 18:30",end:"2018-11-20 20:30",title:"Cross-fit",content:'<i class="w-icon mdi mdi-dumbbell"></i>',class:"sport",schedule:2},{start:"2018-11-21 11:00",end:"2018-11-21 13:00",title:"Brunch with Jane",content:'<i class="w-icon mdi mdi-coffee-outline"></i>',class:"leisure",schedule:1,background:!1},{start:"2018-11-21 19:30",end:"2018-11-21 23:00",title:"Swimming lesson",content:'<i class="w-icon mdi mdi-pool"></i>',class:"sport",schedule:2},{start:"2018-11-23 12:30",end:"2018-11-23 13:00",title:"Macca's with Mark",content:'<i class="w-icon mdi mdi-food"></i>',class:"leisure",schedule:2},{start:"2018-11-23 21:00",end:"2018-11-23 23:30",title:"Movie time",content:'<i class="w-icon mdi mdi-ticket"></i>',class:"leisure",schedule:1},{start:"2018-11-30 21:00",end:"2018-11-30 23:30",title:"Another movie tonight",content:'<i class="w-icon mdi mdi-ticket"></i>',class:"leisure",schedule:1}],N=c(null),o=V({expandedEmittedEvents:c(Array(30).fill(!1)),logs:c([]),clearEventsLog:()=>o.logs=[],logMouseEvents:c(!1),logEvents:(r,e)=>{var w;if(!o.logMouseEvents&&r.includes("-mouse"))return!0;e.cell&&(e.cell={...e.cell,events:e.cell.events.value}),e.e&&(e.e=`[${e.e.constructor.name}]`),o.logs.push({name:r,args:JSON.stringify(e,null,2)});const d=(w=N.value)==null?void 0:w.$el;return H(()=>{var y;return(y=d==null?void 0:d.scrollTo)==null?void 0:y.call(d,{top:d.scrollHeight,behavior:"smooth"})}),!0}}),m=V({loading:!1,events:[],eventsTotal:c(0),onReady:({view:{start:r,end:e}})=>{m.events.push({title:"NAVIGATE WEEKS TO LOAD EVENTS!",start:new Date(r.addDays(3).setHours(10,0,0,0)),end:new Date(r.addDays(3).setHours(14,0,0,0))})},onViewChange:async r=>{m.loading=!0,await j(r.start.format(),r.end.format()),m.loading=!1}}),D=V({selectedDate:c(null),viewDate:c(null)}),p=V({selectedDate:c(null),viewDate:c(null)}),j=async(r,e)=>{await new Promise(y=>setTimeout(y,400));const d=z(r),w=z(e);m.events=B(d,w),m.eventsTotal+=m.events.length},B=(r,e)=>{const d=U(r,e),w=[];let y=0;for(let v=0;v<d;v++)for(let T=0;T<10;T++){const k=new Date(r.addDays(v).setHours(Math.floor(Math.random()*8)+9,Math.floor(Math.random()*60),0,0)),R=k.addHours(1);w.push({title:`Event ${++y}`,start:k,end:R})}return w};return(r,e)=>{const d=E("w-icon"),w=E("alert"),y=E("router-link"),v=E("w-button"),T=E("ssh-pre"),k=E("example"),R=E("w-progress");return x(),C(S,null,[a(k,{title:"Vue Cal Emitted Events",anchor:"emitted-events"},{desc:s(()=>[e[53]||(e[53]=t("p",{class:"mb0"},[l("Vue Cal emits events that you can listen to, to trigger an action outside of Vue Cal."),t("br")],-1)),a(w,null,{default:s(()=>[e[45]||(e[45]=l("If you are not familiar with Vue JS events, you should read about it in the",-1)),t("a",F,[e[44]||(e[44]=l("official Vue documentation.",-1)),a(d,{class:"ml1",color:"primary"},{default:s(()=>[...e[43]||(e[43]=[l("mdi mdi-open-in-new",-1)])]),_:1})])]),_:1}),t("p",null,[e[47]||(e[47]=l(`Here is a quick list of all the events that Vue Cal emits, but you can find more details in the
...
`,-1)])]),default:s(()=>[t("div",G,[a(g(M),{dark:g(b).darkMode,"time-from":540,"time-to":1080,"views-bar":!1,events:m.events,onReady:m.onReady,onViewChange:m.onViewChange,style:{height:"421px"}},null,8,["dark","events","onReady","onViewChange"]),m.loading?(x(),W(R,{key:0,class:"mt-1"})):L("",!0),t("div",q,[m.loading?(x(),C(S,{key:0},[l("Loading events...")],64)):(x(),C(S,{key:1},[l(f(m.eventsTotal)+" events loaded.",1)],64))])])]),_:1}),a(k,{title:"External Controls & use of Vue Cal Methods",anchor:"external-controls"},{desc:s(()=>{var n,h;return[e[79]||(e[79]=t("p",null,[l("You can access any "),t("strong",null,"Vue Cal"),l(" internal method through Vue template ref."),t("br"),l(`
...
`,-1)])]),desc2:s(()=>[e[86]||(e[86]=t("h5",{class:"subtitle-1 font-weight-bold"},"Other useful Vue Cal internal methods & Date prototypes",-1)),a(w,{tip:""},{default:s(()=>[...e[85]||(e[85]=[l(`Along with these Vue Cal internal methods that you can use externally,
...
<vue-cal
  ...
  :views-bar="false"
  sm>
</vue-cal>`,-1)])]),"code-js":s(()=>[...e[89]||(e[89]=[l("const selectedDate = ref(null)",-1)])]),desc2:s(()=>[t("div",te,[a(g(M),{"date-picker":"","views-bar":!1,"selected-date":p.selectedDate,"onUpdate:selectedDate":[e[38]||(e[38]=n=>p.selectedDate=n),e[39]||(e[39]=n=>p.viewDate=n)],"view-date":p.viewDate,dark:g(b).darkMode},null,8,["selected-date","view-date","dark"]),a(g(M),{class:"grow","view-date":p.viewDate,"onUpdate:viewDate":[e[40]||(e[40]=n=>p.viewDate=n),e[42]||(e[42]=n=>p.viewDate=n)],"selected-date":p.selectedDate,"onUpdate:selectedDate":e[41]||(e[41]=n=>p.selectedDate=n),view:"week",views:["day","week"],"views-bar":!1,dark:g(b).darkMode,sm:""},null,8,["view-date","selected-date","dark"])])]),_:1})],64)}}};export{ae as default};
