import{u as x,x as p,a as r,c,d as l,z as H,w as s,f as o,e as i,F as u,b as t,t as m,i as S,r as a}from"./index-WcciNudh.js";import{s as _}from"./index-C2WYxJUz.js";import{_ as g}from"./index-BbUrvQjI.js";const T={class:"w-flex justify-end gap2"},A={__name:"schedules",setup(C){const h=x(),w=[{start:"2018-10-30 10:30",end:"2018-10-30 11:30",title:"Doctor appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:1},{start:"2018-11-16 10:30",end:"2018-11-16 11:30",title:"Doctor appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:1},{start:"2018-11-19 10:35",end:"2018-11-19 11:30",title:"Doctor appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:1},{start:"2018-11-19 18:30",end:"2018-11-19 19:15",title:"Dentist appointment",content:'<i class="w-icon mdi mdi-hospital-box-outline"></i>',class:"health",schedule:2},{start:"2018-11-20 18:30",end:"2018-11-20 20:30",title:"Cross-fit",content:'<i class="w-icon mdi mdi-dumbbell"></i>',class:"sport",schedule:2},{start:"2018-11-21 11:00",end:"2018-11-21 13:00",title:"Brunch with Jane",content:'<i class="w-icon mdi mdi-coffee-outline"></i>',class:"leisure",schedule:1,background:!1},{start:"2018-11-21 19:30",end:"2018-11-21 23:00",title:"Swimming lesson",content:'<i class="w-icon mdi mdi-pool"></i>',class:"sport",schedule:2},{start:"2018-11-23 12:30",end:"2018-11-23 13:00",title:"Macca's with Mark",content:'<i class="w-icon mdi mdi-food"></i>',class:"leisure",schedule:2},{start:"2018-11-23 21:00",end:"2018-11-23 23:30",title:"Movie time",content:'<i class="w-icon mdi mdi-ticket"></i>',class:"leisure",schedule:1},{start:"2018-11-30 21:00",end:"2018-11-30 23:30",title:"Another movie tonight",content:'<i class="w-icon mdi mdi-ticket"></i>',class:"leisure",schedule:1}],n=p({doctorHours:{mon:{from:480,to:1020,class:"doctor-1",label:"<strong>Doctor 1</strong><br><em>Full day shift</em>"},tue:{from:540,to:1080,class:"doctor-2",label:"<strong>Doctor 2</strong><br><em>Full day shift</em>"},wed:[{from:480,to:720,class:"doctor-1",label:"<strong>Doctor 1</strong><br><em>Morning shift</em>"},{from:840,to:1140,class:"doctor-3",label:"<strong>Doctor 3</strong><br><em>Afternoon shift</em>"}],thu:{from:480,to:1020,class:"doctor-1",label:"<strong>Doctor 1</strong><br><em>Full day shift</em>"},fri:{from:540,to:1080,class:"doctor-3",label:"<strong>Doctor 3</strong><br><em>Full day shift</em>"},sat:{from:540,to:1080,class:"doctor-2",label:"<strong>Doctor 2</strong><br><em>Full day shift</em>"},sun:{from:420,to:1200,class:"closed",label:"<strong>Closed</strong>"}},simpleBusinessHours:{mon:{from:540,to:1080,class:"business-hours"},tue:{from:540,to:1080,class:"business-hours"},wed:[{from:540,to:720,class:"business-hours"},{from:840,to:1080,class:"business-hours"}],thu:{from:540,to:1080,class:"business-hours"},fri:{from:540,to:1080,class:"business-hours"}},choices:[{value:"simpleBusinessHours",label:"Simple Business Hours"},{value:"doctorHours",label:"Doctor's Hours"}],businessHoursType:S("simpleBusinessHours")}),d=p({minCellWidth:400,minScheduleWidth:0,schedules:[{id:1,class:"mom",label:"Mom"},{id:2,class:"dad",label:"Dad",hide:!1},{id:3,class:"kid1",label:"Kid 1"},{id:4,class:"kid2",label:"Kid 2"},{id:5,class:"kid3",label:"Kid 3"}],scheduleEvents:[...w.map(b=>({...b})),{start:"2018-11-21 12:00",end:"2018-11-21 12:30",title:"Recall Dave",content:'<i class="w-icon mdi mdi-coffee-outline"></i>',class:"leisure",schedule:1},{start:"2018-11-21 20:00",end:"2018-11-21 22:00",title:"Salsa",content:'<i class="w-icon mdi mdi-walk"></i>',class:"sport",schedule:1},{start:"2018-11-23 21:00",end:"2018-11-23 23:30",title:"Movie time",content:'<i class="w-icon mdi mdi-ticket"></i>',class:"leisure",schedule:2}]});return(b,e)=>{const v=a("w-icon"),k=a("w-radios"),f=a("example"),y=a("alert");return r(),c(u,null,[l(f,{title:"Special Hours (or Business Hours)",anchor:"special-hours"},H({desc:s(()=>[e[2]||(e[2]=t("div",{class:"todo-tag d-iflex"},"MAKE THIS INTERACTIVE",-1)),e[3]||(e[3]=t("p",null,[o("The special hours are visible on "),t("span",{class:"code"},"week"),o(" and "),t("span",{class:"code"},"day"),o(` views and allow
...
`,-1)),t("div",T,[e[1]||(e[1]=t("label",null,"Show:",-1)),l(k,{modelValue:n.businessHoursType,"onUpdate:modelValue":e[0]||(e[0]=D=>n.businessHoursType=D),items:n.choices},{default:s(()=>[l(v,{class:"mr2"},{default:s(()=>[o("mdi mdi-"+m(n.doctorHours?"close":"plus"),1)]),_:1})]),_:1},8,["modelValue","items"])])]),"code-html":s(()=>[e[5]||(e[5]=o(`<vue-cal
  :views="['day', 'week']"
  :time-from="7 * 60"
  :time-to="20 * 60"
  :special-hours="specialHours"
/>`,-1))]),"code-css":s(()=>[n.businessHoursType==="doctorHours"?(r(),c(u,{key:0},[o(`.vuecal__special-hours {
  text-align: center;
...
}`,-1))]),key:"1"}:void 0]),1024),l(f,{title:"Schedules & Schedule Events",anchor:"schedules"},{desc:s(()=>[e[9]||(e[9]=t("div",{class:"todo-tag d-iflex"},"REDO COLORS",-1)),e[10]||(e[10]=t("div",{class:"todo-tag d-iflex ml2"},"ADD MIN-WIDTH & HIDE DAD",-1)),l(y,{class:"text-bold"},{default:s(()=>[...e[8]||(e[8]=[o("This example will be completed soon.",-1)])]),_:1})]),"code-html":s(()=>[...e[11]||(e[11]=[o(`<button @click="minCellWidth = minCellWidth ? 0 : 400">
  `+m("{{ minCellWidth ? 'min cell width: 400px' : 'Add min cell width' }}")+`
</button>
<button @click="minScheduleWidth = minScheduleWidth ? 0 : 200">
  `+m("{{ minScheduleWidth ? 'min schedule width: 200px' : 'Add min schedule width' }}")+`
</button>
